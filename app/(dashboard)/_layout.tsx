  ...
  return (
    <View style={{ marginTop: isMobile ? StatusBarNative.currentHeight : 0 }}>
      ...
      <View className="lg:flex-row">
        ...
        <Pressable android_disableSound style={{cursor: 'auto'}} disabled={ perfilOpen || notificationOpen? false : true} className="lg:w-3/4 xl:w-4/5" onPress={() => {setPerfilOpen(false) ; setNotificationOpen(false)}}>
          <View>
            ...
            <Pressable disabled={notificationOpen? false : true} style={{cursor: 'auto'}} android_disableSound className={`bg-gray-900 w-72 h-96 absolute z-[1] right-7 lg:right-60 top-20 rounded-sm border border-gray-800 ${!notificationOpen && 'hidden'}`} onPress={()=> {setNotificationOpen(true)}}>
              ...
              <ScrollView>
                ...
                <ViewHover onHoverInColor='bg-gray-800' active={false} className='px-5 py-4'>
                  ...
                  <Text className=' text-gray-400 mb-2'>La señora Maria debería estar dando a luz ahora.</Text>
                  <Text style={{fontSize: 12}} className=' text-gray-400'>12 May, 2024</Text>
                </ViewHover>
            ...
            <Pressable style={{cursor: 'auto'}} android_disableSound onPress={()=>{setPerfilOpen(true)}} className={`bg-gray-900 w-64 absolute z-[1] right-7 top-20 rounded-sm border border-gray-800 ${!perfilOpen && 'hidden'}`}>
